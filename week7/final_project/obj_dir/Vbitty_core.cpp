...
Vbitty_core::Vbitty_core(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , Reg_Inst_Out{vlSymsp->TOP.Reg_Inst_Out}
    , Reg_S_Out{vlSymsp->TOP.Reg_S_Out}
    , Reg_C_Out{vlSymsp->TOP.Reg_C_Out}
    , Reg_0_Out{vlSymsp->TOP.Reg_0_Out}
    , Reg_1_Out{vlSymsp->TOP.Reg_1_Out}
    , Reg_2_Out{vlSymsp->TOP.Reg_2_Out}
    , Reg_3_Out{vlSymsp->TOP.Reg_3_Out}
    , Reg_4_Out{vlSymsp->TOP.Reg_4_Out}
    , Reg_5_Out{vlSymsp->TOP.Reg_5_Out}
    , Reg_6_Out{vlSymsp->TOP.Reg_6_Out}
    , Reg_7_Out{vlSymsp->TOP.Reg_7_Out}
    , rootp{&(vlSymsp->TOP)}
{
...
VL_ATTR_COLD void Vbitty_core::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'Vbitty_core::trace()' called on model that was Verilated without --trace option");
}
