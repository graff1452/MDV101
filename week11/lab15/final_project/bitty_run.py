...
# Each of these modules needs to have a testbench written in C++.
MODULES = []
MODULES.append("alu")
MODULES.append("bitty_core")  # Add bitty_core module
...
VERILATE_COMMAND = (
    ...
    "/home/zhan/Desktop/MDV101/week11/lab15/emulator/bitty_emu.cpp "
    "/home/zhan/Desktop/MDV101/week11/lab15/generator/bitty_generator.cpp"
)
...
def print_all_modules():
    ...
    for module in MODULES:
        print(" * {}".format(module))
    print("To compile one of these modules, pick the module and run the script with the -s flag.")
    print("For example:")
...
def main():
    ...
    if hasattr(args, 'help') and args.help:
        ...
        if args.compile_single not in MODULES:
            print(f"Error: Module '{args.compile_single}' not found.")
            print_all_modules()
        else:
