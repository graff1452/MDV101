...
VL_INLINE_OPT void Vcontrol_unit___024root___nba_sequent__TOP__0(Vcontrol_unit___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSelf->moduleName__DOT__reg_state) 
                     << 2U) | (((IData)(vlSelf->run) 
                                << 1U) | (IData)(vlSelf->reset)));
    if (Vcontrol_unit__ConstPool__TABLE_h5078def6_0
        [__Vtableidx1]) {
        vlSelf->moduleName__DOT__reg_state = Vcontrol_unit__ConstPool__TABLE_h3930ad52_0
            [__Vtableidx1];
    }
    moduleName__DOT__reg_en_s = 0U;
    moduleName__DOT__reg_en_c = 0U;
