...
int main(int argc, char** argv)
{
    ...
    for (int test = 0; test < NUM_TESTS; test++)
    {
        ...
        case 0b001:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_1 = " << std::bitset<1>(control_unit->en_1) << ", should be 1" << std::endl;
            }
            break;
        case 0b010:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_2 = " << std::bitset<1>(control_unit->en_2) << ", should be 1" << std::endl;
            }
            break;
        case 0b011:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_3 = " << std::bitset<1>(control_unit->en_3) << ", should be 1" << std::endl;
            }
            break;
        case 0b100:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_4 = " << std::bitset<1>(control_unit->en_4) << ", should be 1" << std::endl;
            }
            break;
        case 0b101:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_5 = " << std::bitset<1>(control_unit->en_5) << ", should be 1" << std::endl;
            }
            break;
        case 0b110:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_6 = " << std::bitset<1>(control_unit->en_6) << ", should be 1" << std::endl;
            }
            break;
        case 0b111:
            ...
            {
                std::cout << "CicleN4: intsruction = " << std::bitset<16>(control_unit->instruction) << std::endl 
                          << "\ten_7 = " << std::bitset<1>(control_unit->en_7) << ", should be 1" << std::endl;
            }
            break;
        default:
