...
extern const VlUnpacked<CData/*2:0*/, 128> Vkeylock__ConstPool__TABLE_h6ee6a7c3_0;
...
VL_INLINE_OPT void Vkeylock___024root___ico_sequent__TOP__0(Vkeylock___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSelf->digit) << 3U) 
                    | (IData)(vlSelf->keylock__DOT__current_state));
    vlSelf->keylock__DOT__next_state = Vkeylock__ConstPool__TABLE_h6ee6a7c3_0
        [__Vtableidx1];
}
...
VL_INLINE_OPT void Vkeylock___024root___nba_sequent__TOP__0(Vkeylock___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    vlSelf->locked = ((IData)(vlSelf->reset) || (7U 
                                                 != (IData)(vlSelf->keylock__DOT__next_state)));
    vlSelf->keylock__DOT__current_state = ((IData)(vlSelf->reset)
                                            ? 0U : (IData)(vlSelf->keylock__DOT__next_state));
    __Vtableidx1 = (((IData)(vlSelf->digit) << 3U) 
                    | (IData)(vlSelf->keylock__DOT__current_state));
    vlSelf->keylock__DOT__next_state = Vkeylock__ConstPool__TABLE_h6ee6a7c3_0
        [__Vtableidx1];
...
void Vkeylock___024root___eval_debug_assertions(Vkeylock___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->digit & 0xf0U))) {
